  ...
  <div class="register">
    ...
    <div>
      ...
      <div class="register-form">
        <van-button class="register-btn" :loading="isLoading" type="info" block loading-text="注册中..." 
        text="注册"
        @click="register"
        :disabled="!isValid"
        />
      </div>
      <div class="login"><router-link class="login-text" to="/login">已有账号？登录</router-link></div>
    </div>
  </div>
</template>
